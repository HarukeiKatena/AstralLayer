...
namespace AstralLayerDirectX11
{
	...
	public:
		...
		/****************************************************************//**
		 * @see AstralLayer::ATLIDevice::CreateRootSignature()
		 *******************************************************************/
		AstralLayer::ATLIRootSignature* CreateRootSignature(
	...
	public:
		...
		/****************************************************************//**
		 * @see Astrallayer::ATLICommandList::SetGraphicsRootSignature()
		 *******************************************************************/
	...
	public:
		...
		/****************************************************************//**
		 * @see Astrallayer::ATLIFence::Release()
		 *******************************************************************/
		void Release()override;
	...
	static const int ROOTSIGNATURE_PARAMETOR = 0;	//!< AstralDirectX11::DX11RootSignature::Gethandle()のHandleで利用する定数
	static const int ROOTSIGNATURE_SAMPLER = 1;		//!< AstralDirectX11::DX11RootSignature::Gethandle()のHandleで利用する定数

	/****************************************************************//**
	 * DX11ルートシグネチャー
	 *******************************************************************/
	class DX11RootSignature : public AstralRHI::RHIRootSignature
	{
	private:
		DX11RootParametor m_Parametor = {};	//!< ルートパラメーター
		DX11SamplerDesc m_Sampler = {};		//!< サンプラー
	...
	public:
		 ...
		 * デスクリプタ
		 *******************************************************************/
		virtual ~DX11RootSignature();

		/****************************************************************//**
		 * @see Astrallayer::ATLIRootSignature::Release()
		 *******************************************************************/
		void Release()override;

		/****************************************************************//**
		 *  @see AstralRHI::RHIRootSignature::GetHandle()
		 *******************************************************************/
		void GetHandle(
			void** ppOut, 
			int Handle
