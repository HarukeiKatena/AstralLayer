	...
	ID3D11Buffer* buffer)
{
	...
	case ATL_SHADER_VISIBILITY::ALL:
		m_pDeferredContext->PSSetConstantBuffers(para->ShaderRegister, 1, &buffer);
		m_pDeferredContext->VSSetConstantBuffers(para->ShaderRegister, 1, &buffer);
		break;
	...
	ID3D11ShaderResourceView* srv)
{
	...
	{
	case ATL_SHADER_VISIBILITY::ALL:
		m_pDeferredContext->VSSetShaderResources(para->ShaderRegister, 1, &srv);
		m_pDeferredContext->PSSetShaderResources(para->ShaderRegister, 1, &srv);
		break;
	case ATL_SHADER_VISIBILITY::PIXEL:
		m_pDeferredContext->PSSetShaderResources(para->ShaderRegister, 1, &srv);
		break;
